import{j as e}from"./iframe-DN3SQIx8.js";import{S as p}from"./progress-ring-Do7C05iB.js";import{S as x}from"./Bronze1-CWitdIqd.js";import{L as c}from"./labeled-progress-ring-BGL9tEaO.js";import{c as i}from"./cn-oknOcaYA.js";import"./preload-helper-DHFrVIEf.js";import"./clsx-B-dksMZM.js";const u="/gravit-web/assets/mobile-banner-B9ZqmRAy.png",g="/gravit-web/assets/pcBannerImage-C4ng6bpO.png";function a({children:t}){return e.jsxs("section",{className:"flex relative w-full h-[266px] md:h-[274px] overflow-hidden",children:[e.jsxs("picture",{className:"absolute inset-0 w-full h-full overflow-hidden z-0",children:[e.jsx("source",{media:"(max-width: 768px)",srcSet:u}),e.jsx("img",{src:g,className:"object-cover object-right h-full w-full",alt:"hero section background"})]}),e.jsx("div",{className:"block md:hidden pointer-events-none absolute inset-x-0 bottom-0 z-5 h-16 bg-gradient-to-t from-gray-200 to-transparent"}),t]})}function h({children:t,className:l,spacing:d="header-aligned"}){const m={"header-aligned":"md:px-19 md:pb-14 p-5 pb-12","content-padded":"max-w-300  mx-auto px-5 pb-12 pb-5 xl:px-0"};return e.jsx("div",{className:i("mt-auto z-10 w-full",m[d],l),children:t})}function b({children:t,className:l}){return e.jsx("div",{className:i("absolute top-0 left-0 p-5 z-10 w-full",l),children:t})}a.Content=h;a.Header=b;a.__docgenInfo={description:"",methods:[{name:"Content",docblock:null,modifiers:["static"],params:[{name:`{
  children,
  className,
