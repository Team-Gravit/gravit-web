import{j as t,L as b,f as y,g,h as T,i as v,k as x,O as f}from"./iframe-Ccg-Y3Fw.js";import{c as p}from"./cn-oknOcaYA.js";import"./preload-helper-DHFrVIEf.js";import"./clsx-B-dksMZM.js";function m({children:e,className:a}){return t.jsx("div",{role:"tablist",className:p("flex items-center w-full gap-1 p-1 md:gap-2 md:p-2 bg-text-1-w rounded-lg md:rounded-xl text-text-3 label1 md:heading2",a),children:e})}function R(e){const a="bg-[var(--primitive-purple-700)] text-text-1-w",o="bg-transparent",r=p("block flex-1 text-center py-2.5 md:py-4 rounded-sm md:rounded-lg transition-colors");if(e.as==="link"){const{as:c,to:n,children:s,...u}=e;return t.jsx(b,{to:n,activeProps:{className:a,"aria-current":"page"},inactiveProps:{className:o},className:r,...u,children:s})}if(e.as==="button"){const{as:c,active:n,children:s,...u}=e;return t.jsx("button",{type:"button",className:p(r,n?a:o),...u,children:s})}}m.Tab=R;m.__docgenInfo={description:"",methods:[{name:"Tab",docblock:null,modifiers:["static"],params:[{name:"props",optional:!1,type:{name:"union",raw:"ButtonTabProps | LinkTabProps",elements:[{name:"intersection",raw:`BaseTabProps &
