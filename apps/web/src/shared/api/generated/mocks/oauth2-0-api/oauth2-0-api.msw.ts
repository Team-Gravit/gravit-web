...
import type { AuthorizeUrl200, LoginResponse } from '../../model';
...
export const getAuthorizeUrlMockHandler = (
  overrideResponse?:
    | AuthorizeUrl200
    | ((
        info: Parameters<Parameters<typeof http.get>[1]>[0],
      ) => Promise<AuthorizeUrl200> | AuthorizeUrl200),
  options?: RequestHandlerOptions,
) => {
  return http.get(
    '*/api/v1/oauth/login-url/:provider',
...
export const getOauth20ApiMock = () => [getOauthLoginMockHandler(), getAuthorizeUrlMockHandler()];
