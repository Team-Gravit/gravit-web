...
describe('TermsPage', () => {
  ...
  it('좁은 화면에서도 문서 제목은 하나이고 조항 수가 같다', async () => {
    stubViewport(false);
  ...
  it('타이포·굵기를 토큰 대신 직접 지정하던 클래스가 남아 있지 않다', async () => {
    ...
    const { container } = await renderTermsPage();
