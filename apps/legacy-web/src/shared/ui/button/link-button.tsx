...
type InlineLinkButtonProps = { display?: 'inline' } & VariantProps<typeof inlineButtonVariants>;

type BlockLinkButtonProps = { display: 'block' } & VariantProps<typeof blockButtonVariants>;
