...
const bgCardVariants = cva(' flex flex-col w-full bg-cover bg-center bg-no-repeat h-fit', {
  variants: {
    size: {
...
export default function BgCard({ children, className, size = 'md', backgroundImage }: BgCardProps) {
  return (
    <div
