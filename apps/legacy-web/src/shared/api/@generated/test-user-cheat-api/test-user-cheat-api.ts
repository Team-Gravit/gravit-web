...
export const getCreateUserMutationOptions = <TError = LoginResponse,
...
const {mutation: mutationOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CreateUserMutationError = LoginResponse

    /**
 * @summary [테스트] 치트 유저 생성
 */
export const useCreateUser = <TError = LoginResponse,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createUser>>, TError,{params: CreateUserParams}, TContext>, }
 , queryClient?: QueryClient): UseMutationResult<
