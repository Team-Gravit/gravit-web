...
export default function UserSidebar() {
  const { data: userInfo, isLoading: isUserLoading, isError: isUserError } = useUserInfo();
  const { data: userBadges, isLoading: isBadgesLoading, isError: isBadgesError } = useBadges();
