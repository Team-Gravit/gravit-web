  ...
  let content = (
    <div className="relative flex flex-col text-white z-10 gap-2">
      <div className="flex justify-between items-center">
        <p className="text-3xl font-semibold">최근에 진행한 학습 정보가 없습니다.</p>
        <button type="button" className="cursor-pointer">
          <ArrowButton />
        </button>
      </div>

      <h3 className="text-[40px] font-mbc font-normal">새로운 학습을 시작하기</h3>
    </div>
  );
      ...
      <>
        <div className="relative z-10">
          <div className="flex justify-between items-center mb-2">
            <p className="text-white text-3xl font-semibold text-center">이어서 학습하기</p>
            <Tooltip
              button={
                <div>
          ...
          <LessonProgressBar progressRate={learningSummary.recentSolvedChapterProgressRate} />
        </div>
