...
export default function LevelProgressCircle({ xp, children }: LevelProgressCircleProps) {
  const size = 60;
  const strokeWidth = 4;
  ...
  return (
    <div className="relative w-[60px] h-[60px] flex items-center justify-center">
      <div className="absolute inset-0 flex items-center justify-center z-0">{children}</div>
