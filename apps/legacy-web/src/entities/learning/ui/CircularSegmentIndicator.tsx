...
const CircularSegmentIndicator = ({
  ...
  const calculateSegmentProgress = (segmentIndex: number, totalProgress: number) => {
  ...
  const generateSegmentId = (type: 'inactive' | 'active', segmentIndex: number) =>
  ...
  return (
    <div className="relative flex items-center justify-center">
      ...
      >
        ...
        {Array.from({ length: totalLessonsCount }, (_, index) => {
          const segmentData = calculateSegmentPath(index, radius, centerX, centerY);
          const segmentProgress = calculateSegmentProgress(index, progressPercentage);
      ...
      >
        ...
        {settings.showInactiveSegments &&
          Array.from({ length: totalLessonsCount }, (_, index) => {
            const segmentData = calculateSegmentPath(index, smallRadius, smallCenter, smallCenter);
            return (
              <path
                key={generateSegmentId('inactive', index)}
                d={segmentData.path}
