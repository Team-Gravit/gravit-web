...
function ChapterCard({ chapter }: { chapter: Chapter }) {
	...
	return (
		<article
			key={chapterId}
			className="cursor-pointer relative flex flex-col justify-between lg:justify-start w-full h-64 lg:max-w-[300px] lg:h-72 bg-cover bg-center rounded-[10px] overflow-hidden p-4 group"
