...
import { createQuizSessionState, type QuizMode, type SubmitStrategy } from './quiz-session-store';
...
export const QuizStoreProvider = ({
  ...
  return (
    <QuizStoreContext.Provider value={{ mode, strategy, lessonId, unitId, store }}>
      {children}
