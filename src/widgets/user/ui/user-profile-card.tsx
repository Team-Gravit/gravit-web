...
import EditProfileModal from '@/widgets/profile/ui/edit-profile-modal';
    ...
    <>
      ...
      >
        ...
        <div className="relative flex flex-col w-full h-full gap-3 px-4 py-6 md:p-8">
          <div className="flex-1 flex min-h-0">
            <div className="flex-1 flex items-center gap-3 md:gap-8">
              ...
              <div className="flex flex-col gap-1">
                ...
                <p className="text-semantic-info body1-normal mb-2 max-md:hidden">{`@${handle}`}</p>
            ...
            <div className="flex items-center gap-3 self-start">
              <Button type="button" onClick={handleEditProfileClick} className="max-md:hidden">
                프로필 수정
              </Button>
          ...
          <p className="text-semantic-info body2-normal text-sm md:hidden">{`@${handle}`}</p>
          <Button
            type="button"
            variant={'secondary'}
...
function ProfileCardLabel({
  ...
  return (
    <span className={cn('bg-white/20 px-2 py-0.5 rounded-lg md:py-1 md:px-4', className)}>
      {children}
    </span>
  );
}
