...
function SocialFollowSection() {
	const { data, isPending: isGetFollowCountPending } =
		useGetFollowAndFollowingCount();
...
function SocialFollowSectionView({
	followerCount,
	followingCount,
}: SocialFollowSectionViewProps) {
		...
		<>
			...
			>
				<div className="flex items-center justify-center md:gap-6 ">
					...
					<div
						aria-hidden
						className="md:hidden w-px h-10 shrink-0 bg-divider-1"
					/>
					<StatItem
