...
export default forwardRef<AnswerPhaseHandle, { problem: Problem }>(function IncorrectAnswerPhase(
  { problem },
  ref,
) {
  ...
  if (problemType === 'SUBJECTIVE') {
    return <SubjectiveSolver ref={subjectiveSolverRef} answers={answer.content} />;
  }
