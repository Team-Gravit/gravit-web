...
function RouteComponent() {
  ...
  const { lessons, unitInfo, isPending, data } = useFetchLessons(Number(unitId));
    ...
    <BackgroundLayout backgroundImage={backgroundImg} gradientOverlay="partial">
      <main className="w-full max-w-[1580px] px-16 lg:px-20 xl:px-24 pt-10 lg:pt-24 pb-44 mx-auto">
        <div className="flex flex-row justify-between">
          <ContentSectionHeader title={unitInfo.unitName} description={unitInfo.unitDescription} />
          <Link
        ...
        <div className="w-full grid grid-rows-[auto_auto] grid-cols-[1fr_1fr] gap-x-8 gap-y-7 lg:gap-x-16 lg:gap-y-14">
          <section className="flex flex-col gap-4">
            ...
            <div className="relative w-full rounded-2xl px-8 py-8 bg-white">
              ...
              <h4 className="text-gray-900 font-semibold text-2xl mb-2">북마크</h4>
              <p className="text-gray-800 text-xl mb-11">북마크한 문제를 풀어요.</p>
              <Link
          ...
          <section className="flex flex-col gap-4">
            ...
            <div className="relative w-full rounded-2xl px-8 py-8 bg-white">
              ...
              <h4 className="text-gray-900 font-semibold text-2xl mb-2">오답노트</h4>
              <p className="text-gray-800 text-xl mb-11">틀린 문제를 복습해요.</p>
              <Link
