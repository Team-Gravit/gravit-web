...
export const Route = createFileRoute(
	"/_authenticated/_fixed-header-layout/chapters/$chapterId/units/$unitId/lessons/$lessonId",
)({
			...
			<main className="w-full max-w-[1580px] px-16 lg:px-20 xl:px-24 pt-10 lg:pt-24 pb-44 mx-auto">
				<ChapterInfo
					...
					chapterInfoText="배열, 연결리스트, 스택, 등 기본적인 자료구조의 개념과 구현을
									학습하는 챕터입니다"
				/>
				<div className="grid grid-rows-[auto_auto] grid-cols-2 gap-x-16 gap-y-14">
