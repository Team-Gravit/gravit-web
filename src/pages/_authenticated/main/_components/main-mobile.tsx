    ...
    <div className="flex flex-col min-h-screen w-full bg-bg-2">
      <HeroSection>
        <HeroSection.Content className="text-white">
          <p className="text-title3 mb-1">어서오세요, {vm.progress.nickname}님!</p>
          <p className="text-body1-normal">그래빗과 함께 CS 지식을 마스터해요!</p>
        </HeroSection.Content>
      </HeroSection>
        ...
        <div className="p-4 md:py-0">
          <div className="w-full flex flex-col gap-4">
            ...
            <div className="w-full flex gap-4 h-[195px]">
              {vm.mission && <MissionCard className="flex-1 h-full" missionDetail={vm.mission} />}
              {vm.units.items[0] && (
                <UnitCard
