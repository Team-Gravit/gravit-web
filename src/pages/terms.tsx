				...
				<div className="w-full max-w-[800px] px-8 py-12">
					...
					<ol className="list-decimal list-inside mb-4 space-y-2 ml-4">
						<li>
							...
							통해 제공되는 CS 학습 콘텐츠, 리그 경쟁 시스템, 면접 시뮬레이터 등
							모든 기능을 의미합니다.
						</li>
						<li>
					...
					<ol className="list-decimal list-inside mb-4 space-y-2 ml-4">
						...
						<li>
							기타 서비스가 추가 개발하거나 제휴 계약 등을 통해 제공하는 서비스
						</li>
					</ol>
					...
					<ol className="list-decimal list-inside mb-4 space-y-2 ml-4">
						...
						<li>
							서비스 내용, 이용방법, 이용시간에 대한 변경이 있는 경우 변경사유,
							변경내용 및 제공일자 등을 그 변경 전 7일 이상 해당 서비스 화면에
							게시합니다.
						</li>
						<li>
					...
					<ol className="list-decimal list-inside mb-4 space-y-2 ml-4">
						<li>
							...
							<ul className="list-disc list-inside ml-6 mt-2 space-y-1">
								...
								<li>
									공공질서 및 미풍양속에 위반되는 내용의 정보, 문장, 도형, 음향,
									동영상을 전송, 게시, 전자우편 또는 기타의 방법으로 타인에게
									유포하는 행위
								</li>
					...
					<ol className="list-decimal list-inside mb-4 space-y-2 ml-4">
						<li>
							회원은 언제든지 서비스 내 설정 메뉴 또는 고객센터를 통해 이용계약
							해지 신청을 할 수 있으며, 서비스는 관련 법령에 따라 이를 즉시
							처리합니다.
						</li>
						<li>
							서비스는 회원이 제8조의 의무를 위반하거나 서비스의 정상적인 운영을
						...
						<li>
							...
							불법통신, 해킹, 악성프로그램의 배포, 접속권한 초과행위 등과 같이
					...
					<ol className="list-decimal list-inside mb-4 space-y-2 ml-4">
						<li>
							서비스는 천재지변, 전쟁, 기간통신사업자의 서비스 중지 및 기타 이에
							준하는 불가항력으로 인하여 서비스를 제공할 수 없는 경우에는 서비스
							제공에 대한 책임이 면제됩니다.
						</li>
						<li>
							서비스는 이용자의 귀책사유로 인한 서비스 이용 장애에 대하여 책임을
							지지 않습니다.
						</li>
						<li>
							서비스는 이용자가 서비스를 이용하여 기대하는 효용(학습 성과, 취업
							등)을 얻지 못한 것에 대해 책임을 지지 않습니다.
						</li>
						<li>
							서비스는 이용자 간 또는 이용자와 제3자 상호 간에 서비스를 매개로
							하여 거래 등을 한 경우에는 책임을 지지 않습니다.
						</li>
					</ol>
