    ...
    <>
      ...
      <main className="flex-grow flex flex-col items-center w-full">
        <div className="w-full max-w-[800px] px-8 py-12">
          ...
          <h2 className="text-xl font-semibold mt-8 mb-3">1. 개인정보의 수집 항목 및 수집 방법</h2>
          ...
          <h2 className="text-xl font-semibold mt-8 mb-3">2. 개인정보의 수집 및 이용 목적</h2>
          ...
          <h2 className="text-xl font-semibold mt-8 mb-3">3. 개인정보의 보유 및 이용 기간</h2>
          <ul className="list-disc list-inside mb-4 ml-4">
            <li>
              <span className="font-semibold">회원 탈퇴 시:</span> 즉시 파기 (단, 관련 법령에 따라
              보관이 필요한 경우 예외)
            </li>
            <li>
              <span className="font-semibold">법령에 따른 보관:</span> 전자상거래법 등 관련 법령에
              따라 일정 기간 보관
          ...
          <h2 className="text-xl font-semibold mt-8 mb-3">5. 개인정보 처리 위탁</h2>
          <p className="mb-4">
          ...
          <h2 className="text-xl font-semibold mt-8 mb-3">6. 정보주체의 권리·의무 및 행사 방법</h2>
          ...
          <p className="mb-4">
            ...
            <a href="mailto:xunssoie@gmail.com" className="text-blue-600 hover:underline">
              xunssoie@gmail.com
            </a>
            )를 통해 가능합니다.
          </p>

          <h2 className="text-xl font-semibold mt-8 mb-3">7. 개인정보의 파기</h2>
          <p className="mb-4">
            서비스는 개인정보 보유 기간의 경과, 처리 목적 달성 등 개인정보가 불필요하게 되었을 때
            지체 없이 해당 개인정보를 파기합니다.
          </p>
          <p className="font-semibold mb-2">파기 절차</p>
          <ul className="list-disc list-inside mb-4 ml-4">
            <li>
              이용자가 입력한 정보는 목적 달성 후 내부 방침 및 관련 법령에 따라 일정 기간 저장 후
              파기
            </li>
          </ul>
          ...
          <h2 className="text-xl font-semibold mt-8 mb-3">8. 개인정보 보호책임자</h2>
          <p className="mb-4">
            서비스는 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한
            정보주체의 불만 처리 및 피해구제를 위하여 아래와 같이 개인정보 보호책임자를 지정하고
            있습니다.
          </p>
          ...
          <h2 className="text-xl font-semibold mt-8 mb-3">9. 개인정보 처리방침의 변경</h2>
          <p className="mb-4">
            본 개인정보 처리방침은 법령·정책 또는 보안기술의 변경에 따라 내용의 추가·삭제 및 수정이
            있을 시 시행일자 최소 7일 전에 서비스 공지사항을 통해 고지합니다.
          </p>
