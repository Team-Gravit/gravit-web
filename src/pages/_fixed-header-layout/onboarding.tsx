...
function OnboardingPage() {
	...
	const handleSubmit = async () => {
		...
		try {
			await PostOnBoarding(nickname.trim(), colorIndex);
			navigate({ to: "/success" });
		} catch (error) {
	...
	return (
		<Background>
			<Logo />
			<Form className="w-[549px] h-[460px] p-8">
				...
				<button
					...
					className={`w-[335px] h-14 text-white py-2 rounded-xl text-lg font-semibold transition mb-auto
