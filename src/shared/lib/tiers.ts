...
export const tiers = [
	{ id: 1, name: "브론즈 1", icon: Bronze1 },
	{ id: 2, name: "브론즈 2", icon: Bronze2 },
	{ id: 3, name: "브론즈 3", icon: Bronze3 },
	{ id: 4, name: "실버 1", icon: Silver1 },
	{ id: 5, name: "실버 2", icon: Silver2 },
	{ id: 6, name: "실버 3", icon: Silver3 },
	{ id: 7, name: "골드 1", icon: Gold1 },
	{ id: 8, name: "골드 2", icon: Gold2 },
	{ id: 9, name: "골드 3", icon: Gold3 },
	{ id: 10, name: "플래티넘 1", icon: Platinum1 },
	{ id: 11, name: "플래티넘 2", icon: Platinum2 },
	{ id: 12, name: "플래티넘 3", icon: Platinum3 },
	{ id: 13, name: "다이아 1", icon: Diamond1 },
	{ id: 14, name: "다이아 2", icon: Diamond2 },
	{ id: 15, name: "다이아 3", icon: Diamond3 },
];
