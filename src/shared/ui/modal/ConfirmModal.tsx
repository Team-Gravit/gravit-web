...
export const ConfirmModal = forwardRef<ConfirmModalRef, ConfirmModalProps>(function ConfirmModal(
  { title, description, confirmText = '확인', cancelText = '취소', onConfirm, onCancel },
  ref,
) {
