...
**reportType** | **string** | 신고 유형 | [optional] [default to undefined]
**problemId** | **number** | 문제 ID | [optional] [default to undefined]
**content** | **string** | 신고 내용 | [optional] [default to undefined]
**isResolved** | **boolean** | 해결 여부 | [optional] [default to undefined]
**submittedAt** | **string** | 신고 접수 시간 | [optional] [default to undefined]
