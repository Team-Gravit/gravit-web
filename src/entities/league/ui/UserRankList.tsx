...
export default function UserRankList({ users, loading, highlightUserId }: UserListProps) {
  return (
    <div className="flex flex-col w-full gap-5">
      {users.map((user) => {
        const profileBgColor = PROFILE_COLORS[user.profileImgNumber as keyof typeof PROFILE_COLORS];
            ...
            >
              ...
              <div className="flex w-14 h-14 items-center justify-center">
                <LevelProgressCircle xp={user.xp}>
                  <Profile2 className="w-[56px] h-[56px]" style={{ color: profileBgColor }} />
                </LevelProgressCircle>
              </div>
              <span
