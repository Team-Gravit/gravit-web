...
import type { LastSeasonPopup, LeagueInfo, UserLeagueInfo, UserLeagues } from './types';
...
export function mapToUserLeagueInfo(raw: MyLeagueRankWithProfileResponse): UserLeagueInfo {
