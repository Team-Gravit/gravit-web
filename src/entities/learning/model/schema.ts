...
export const toWeeklyLearningRecord = (raw: WeeklyLearningRecordResponse): WeeklyLearningRecord =>
  weeklyLearningRecordSchema.parse(raw);

export const toLearningDetail = (raw: LearningDetailResponse): LearningDetail =>
  learningDetailSchema.parse(raw);

export const toRecommendedUnit = (raw: RecommendedUnitResponse): RecommendedUnit =>
  recommendedUnitSchema.parse(raw);
